...
public class PixelAssemblerGuiMenu extends AbstractContainerMenu implements IEnergyMenu, IFluidMenu {
    public final PixelAssemblerTile blockEntity;
    private final Level level;
    private final ContainerData data;
    private FluidStack fluid;

    public PixelAssemblerGuiMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(6));
    }

    public PixelAssemblerGuiMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(POMmenuType.PIXEL_ASSEMBLER_MENU.get(), pContainerId);
