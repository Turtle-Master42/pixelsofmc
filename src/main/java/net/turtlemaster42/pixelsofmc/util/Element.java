...
public enum Element {
    ...
    CALCIUM(20, 40.08f, true, false, false,
            new Isotopes(new int[]{24, 26, 28}, new float[]{43.96f, 45.95f, 47.95f}, new boolean[]{false, false, true}),
    ...
    NICKEL(30, 58.69f, true, false, false,
            new Isotopes(new int[]{31, 32, 34}, new float[]{58.93f, 59.93f, 61.93f}, new boolean[]{true, false, false}),
    ...
    GALLIUM(38, 69.72f,
            new Isotopes(40, 70.92f, false),
            new Info(300, 2650, "9495AE", "595D7E", "302F42", Danger.CORROSIVE)),
    GERMANIUM(41, 72.63f,
            new Isotopes(new int[]{40, 42}, new float[]{71.92f, 72.92f}),
    ...
    TIN(69,118.71f, true, false, false,
    ...
    XENON(77, 131.29f, ItemType.CANISTER,
