...
public class POMblockLootTableProvider extends BlockLootSubProvider {
    protected POMblockLootTableProvider() {
    ...
    protected void generate() {
        ...
        this.dropSelf(POMblocks.INDUSTRIAL_COOLER.get());
        ...
        this.dropSelf(POMblocks.FISSION_ENERGY_PORT.get());
        this.dropSelf(POMblocks.FISSION_FLUID_PORT.get());
        ...
        this.dropSelf(POMblocks.HEAT_SINK.get());
        this.dropSelf(POMblocks.FUSION_ENERGY_PORT.get());
        this.dropSelf(POMblocks.FUSION_ITEM_PORT.get());
        this.dropSelf(POMblocks.FUSION_FLUID_PORT.get());
        this.dropSelf(POMblocks.FUSION_PLASMA_PORT.get());
        ...
        this.dropOther(POMblocks.LIQUID_LEAD_BLOCK.get(), Items.AIR);
        ...
        this.add(POMblocks.ACANTHITE_SPIKE.get(), (block) ->
                createSilkTouchDispatchTable(block,
                        this.applyExplosionDecay(block,
                                LootItem.lootTableItem(POMitems.ACANTHITE_DUST.get())
        ...
        this.add(POMblocks.LESSER_ACANTHITE_ORE.get(), (block) ->
                createSilkTouchDispatchTable(block,
                        this.applyExplosionDecay(block,
                                LootItem.lootTableItem(POMitems.ACANTHITE_DUST.get())
        ...
        this.add(POMblocks.ACANTHITE_ORE.get(), (block) ->
                createSilkTouchDispatchTable(block,
                        this.applyExplosionDecay(block,
                                LootItem.lootTableItem(POMitems.ACANTHITE_DUST.get())
        ...
        this.add(POMblocks.ACANTHITE.get(), (block) ->
                createSilkTouchDispatchTable(block,
                        this.applyExplosionDecay(block,
                                LootItem.lootTableItem(POMitems.ACANTHITE_DUST.get())
