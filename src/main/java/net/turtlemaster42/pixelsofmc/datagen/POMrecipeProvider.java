...
public class POMrecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(@NotNull Consumer<FinishedRecipe> fConsumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, POMitems.EMPTY_CELL.get(), 4)
                ...
                .save(fConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, POMitems.EMPTY_FUEL_CELL.get(), 4)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, POMblocks.CHEMICAL_SEPARATOR.get())
                ...
                .define('C', POMitems.ADVANCED_CIRCUIT_BOARD_2.get())
                .define('D', POMblocks.ADVANCED_CASING_2.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, POMblocks.CHEMICAL_MIXER.get())
                ...
                .unlockedBy("has_items", inventoryTrigger(HAS_TITANIUM_DIBORIDE))
                .save(fConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, POMblocks.PIXEL_BOMBARDER.get())
                .define('A', POMitems.TITANIUM_DIBORIDE_INGOT.get())
                .define('B', POMitems.ROYAL_TUNGSTEN_WIRE.get())
                .define('C', POMblocks.PERFECTED_CASING_2.get())
                .define('D', POMitems.ADVANCED_LASER.get())
                .define('E', POMitems.PERFECTED_CIRCUIT_BOARD_2.get())
                .pattern("ABA")
                .pattern("CDC")
                .pattern("AEA")
                .unlockedBy("has_items", inventoryTrigger(HAS_TITANIUM_DIBORIDE))
                .save(fConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, POMblocks.PIXEL_SPLITTER.get())
                .define('A', POMitems.TITANIUM_DIBORIDE_INGOT.get())
                .define('B', POMitems.PERFECTED_CIRCUIT_BOARD_2.get())
                .define('C', POMitems.TITANIUM_DIBORIDE_PLATING.get())
                .define('D', POMblocks.SIMPLE_CASING_2.get())
                .define('E', POMblocks.PERFECTED_CASING_2.get())
                .pattern("ABA")
                .pattern("C C")
                .pattern("DED")
                .unlockedBy("has_items", inventoryTrigger(HAS_TITANIUM_DIBORIDE))
                .save(fConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, POMblocks.PIXEL_ASSEMBLER.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, POMitems.ADVANCED_LASER.get())
                ...
                .define('F', POMitems.VIOLET_DIAMOND.get())
                .pattern("ABA")
                .pattern("CDC")
                .pattern("EFE")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, POMblocks.PYROLYTIC_CARBON_SHEET_STAIRS.get(), 4)
                ...
                .unlockedBy("has_items", inventoryTrigger(
                        toItemP(POMitems.PYROLYTIC_CARBON_SHEET.get())))
                .save(fConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, POMblocks.MACHINE_CASING_STAIRS.get(), 4)
                .define('A', POMblocks.MACHINE_CASING.get())
                .pattern("A  ")
                .pattern("AA ")
                .pattern("AAA")
                .unlockedBy("has_items", inventoryTrigger(
                        toItemP(POMblocks.MACHINE_CASING.get().asItem())))
                .save(fConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, POMblocks.FISSION_CASING_STAIRS.get(), 4)
                .define('A', POMblocks.FISSION_CASING.get())
                .pattern("A  ")
                .pattern("AA ")
                .pattern("AAA")
                .unlockedBy("has_items", inventoryTrigger(
                        toItemP(POMblocks.FISSION_CASING.get().asItem())))
                .save(fConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, POMblocks.ARMORED_MACHINE_CASING_STAIRS.get(), 4)
                .define('A', POMblocks.ARMORED_MACHINE_CASING.get())
                .pattern("A  ")
                .pattern("AA ")
                .pattern("AAA")
                .unlockedBy("has_items", inventoryTrigger(
                        toItemP(POMblocks.ARMORED_MACHINE_CASING.get().asItem())))
                .save(fConsumer);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, POMblocks.PYROLYTIC_CARBON_SHEET_SLAB.get(), 6)
                ...
                .unlockedBy("has_items", inventoryTrigger(
                        toItemP(POMitems.PYROLYTIC_CARBON_SHEET.get())))
                .save(fConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, POMblocks.MACHINE_CASING_SLAB.get(), 6)
                .define('A', POMblocks.MACHINE_CASING.get())
                .pattern("AAA")
                .unlockedBy("has_items", inventoryTrigger(
                        toItemP(POMblocks.MACHINE_CASING.get().asItem())))
                .save(fConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, POMblocks.FISSION_CASING_SLAB.get(), 6)
                .define('A', POMblocks.FISSION_CASING.get())
                .pattern("AAA")
                .unlockedBy("has_items", inventoryTrigger(
                        toItemP(POMblocks.FISSION_CASING.get().asItem())))
                .save(fConsumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, POMblocks.ARMORED_MACHINE_CASING_SLAB.get(), 6)
                .define('A', POMblocks.ARMORED_MACHINE_CASING.get())
                .pattern("AAA")
                .unlockedBy("has_items", inventoryTrigger(
                        toItemP(POMblocks.ARMORED_MACHINE_CASING.get().asItem())))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, POMblocks.ARMORED_MACHINE_CASING.get(), 4)
                ...
                .pattern("BCB")
                .pattern("ABA")
                .unlockedBy("has_items", inventoryTrigger(toItemP(POMitems.FUSION_PLATING.get())))
                .save(fConsumer);
        ...
        GrinderRecipeBuilder.build(Items.MAGMA_BLOCK)
                .output(POMitems.QUARTZ_DUST.get(), 0.5f)
                .output(Element.IRON.dust(), 0.20f)
        ...
        GrinderRecipeBuilder.build(Items.BLACKSTONE)
                .output(Element.IRON.dust(), 0.66f)
                .output(Element.BORON.dust(), 0.5f)
                .output(Element.COBALT.dust(),0.25f)
                .output(Element.LEAD.dust(),0.15f)
                .output(POMitems.QUARTZ_DUST.get(),0.05f)
                .output(Element.GOLD.dust(),0.02f)
                .finish(fConsumer, this);
        ...
        GrinderRecipeBuilder.build(POMblocks.ACANTHITE.get().asItem())
                ...
                .output(Element.SILVER.dust(), 0.10f)
                .output(Element.PLATINUM.dust(), 0.04f)
                .finish(fConsumer, this);
        ...
        BallMillRecipeBuilder.build(Items.AMETHYST_SHARD, 4).ball(POMtags.Items.BALL_4)
                ...
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.AMETHYST_SHARD, 12).ball(POMtags.Items.BALL_3)
                .input(Items.AMETHYST_CLUSTER)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.AMETHYST_SHARD, 3).ball(POMtags.Items.BALL_3)
                .input(Items.LARGE_AMETHYST_BUD)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.AMETHYST_SHARD, 1).ball(POMtags.Items.BALL_3)
                .input(Items.MEDIUM_AMETHYST_BUD)
                .finish(fConsumer, this);

        BallMillRecipeBuilder.build(Items.DISC_FRAGMENT_5, 6).ball(POMtags.Items.BALL_3)
        ...
        BallMillRecipeBuilder.build(Items.MELON_SLICE, 8).ball(POMtags.Items.BALL_1)
                .input(Items.MELON)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.MELON_SEEDS, 2).ball(POMtags.Items.BALL_3)
        ...
        BallMillRecipeBuilder.build(Items.PRISMARINE_SHARD,2).ball(POMtags.Items.BALL_4)
                ...
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.PRISMARINE_CRYSTALS,4).ball(POMtags.Items.BALL_3)
                .input(Items.SEA_LANTERN)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.BRICK,1).ball(POMtags.Items.BALL_3)
                .input(Items.FLOWER_POT)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.GLOWSTONE_DUST,4).ball(POMtags.Items.BALL_3)
                .input(Items.GLOWSTONE)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.COBBLESTONE,1).ball(POMtags.Items.BALL_3)
                .input(Items.STONE_BRICKS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.COBBLESTONE,1).ball(POMtags.Items.BALL_3)
                .input(Items.CRACKED_STONE_BRICKS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.COBBLESTONE,1).ball(POMtags.Items.BALL_3)
        ...
        BallMillRecipeBuilder.build(Items.COBBLESTONE,1).ball(POMtags.Items.BALL_3)
                ...
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.MOSSY_COBBLESTONE,1).ball(POMtags.Items.BALL_3)
                .input(Items.MOSSY_STONE_BRICKS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.COBBLED_DEEPSLATE,1).ball(POMtags.Items.BALL_3)
                .input(Items.DEEPSLATE_BRICKS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.COBBLED_DEEPSLATE,1).ball(POMtags.Items.BALL_3)
                .input(Items.CRACKED_DEEPSLATE_BRICKS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.COBBLED_DEEPSLATE,1).ball(POMtags.Items.BALL_3)
                .input(Items.POLISHED_DEEPSLATE)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.COBBLED_DEEPSLATE,1).ball(POMtags.Items.BALL_3)
                .input(Items.CHISELED_DEEPSLATE)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.COBBLED_DEEPSLATE,1).ball(POMtags.Items.BALL_3)
                .input(Items.DEEPSLATE_TILES)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.COBBLED_DEEPSLATE,1).ball(POMtags.Items.BALL_3)
                .input(Items.CRACKED_DEEPSLATE_TILES)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.BLACKSTONE,1).ball(POMtags.Items.BALL_3)
                .input(Items.CHISELED_POLISHED_BLACKSTONE)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.BLACKSTONE,1).ball(POMtags.Items.BALL_3)
        ...
        BallMillRecipeBuilder.build(Items.BLACKSTONE,1).ball(POMtags.Items.BALL_3)
                ...
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.BLACKSTONE,1).ball(POMtags.Items.BALL_3)
                .input(Items.CRACKED_POLISHED_BLACKSTONE_BRICKS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.GOLD_NUGGET,6).ball(POMtags.Items.BALL_3)
                .input(Items.GILDED_BLACKSTONE)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.BRICKS,3).ball(POMtags.Items.BALL_3)
                .input(Items.BRICKS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.BRICKS,2).ball(POMtags.Items.BALL_3)
                .input(Items.BRICK_STAIRS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.BRICKS,1).ball(POMtags.Items.BALL_3)
                .input(Items.BRICK_WALL)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.BRICKS,1).ball(POMtags.Items.BALL_3)
                .input(Items.BRICK_SLAB)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.NETHER_BRICK,3).ball(POMtags.Items.BALL_3)
                .input(Items.NETHER_BRICKS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.NETHER_BRICK,2).ball(POMtags.Items.BALL_3)
                .input(Items.CRACKED_NETHER_BRICKS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.NETHER_BRICK,3).ball(POMtags.Items.BALL_3)
                .input(Items.CHISELED_NETHER_BRICKS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.NETHER_BRICK,2).ball(POMtags.Items.BALL_3)
                .input(Items.NETHER_BRICK_STAIRS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.NETHER_BRICK,1).ball(POMtags.Items.BALL_3)
                .input(Items.NETHER_BRICK_SLAB)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.NETHER_BRICK,1).ball(POMtags.Items.BALL_3)
                .input(Items.NETHER_BRICK_WALL)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.NETHER_BRICK,1).ball(POMtags.Items.BALL_3)
                .input(Items.NETHER_BRICK_FENCE)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.POPPED_CHORUS_FRUIT,3).ball(POMtags.Items.BALL_3)
                .input(Items.PURPUR_BLOCK)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.POPPED_CHORUS_FRUIT,3).ball(POMtags.Items.BALL_3)
                .input(Items.PURPUR_PILLAR)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.POPPED_CHORUS_FRUIT,2).ball(POMtags.Items.BALL_3)
                .input(Items.PURPUR_STAIRS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.POPPED_CHORUS_FRUIT,1).ball(POMtags.Items.BALL_3)
                .input(Items.PURPUR_SLAB)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.QUARTZ,3).ball(POMtags.Items.BALL_3)
        ...
        BallMillRecipeBuilder.build(Items.QUARTZ,3).ball(POMtags.Items.BALL_3)
                ...
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.QUARTZ,2).ball(POMtags.Items.BALL_3)
                .input(Items.QUARTZ_STAIRS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.QUARTZ,2).ball(POMtags.Items.BALL_3)
                .input(Items.SMOOTH_QUARTZ_STAIRS)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.QUARTZ,1).ball(POMtags.Items.BALL_3)
                .input(Items.QUARTZ_SLAB)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.QUARTZ,1).ball(POMtags.Items.BALL_3)
                .input(Items.SMOOTH_QUARTZ_SLAB)
                .finish(fConsumer, this);
        ...
        BallMillRecipeBuilder.build(POMitems.ANCIENT_DEBRIS_DUST.get(),3).ball(POMtags.Items.BALL_5)
                ...
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(POMitems.NETHERITE_DUST.get()).ball(POMtags.Items.BALL_4)
        ...
        //crushing
        BallMillRecipeBuilder.build(Items.SUGAR,2).ball(POMtags.Items.BALL_3)
                .input(Items.SUGAR_CANE)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.BLAZE_POWDER,4).ball(POMtags.Items.BALL_3)
                .input(Items.BLAZE_ROD)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.BONE_MEAL, 5).ball(POMtags.Items.BALL_3)
                .input(Items.BONE)
                .finish(fConsumer, this);
        ...
        BallMillRecipeBuilder.build(Items.WHITE_DYE, 4).ball(POMtags.Items.BALL_4)
                .input(POMitems.TITANIUM_OXIDE_DUST.get())
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.COAL, 4).ball(POMtags.Items.BALL_3)
                .input(Tags.Items.ORES_COAL)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.DIAMOND, 3).ball(POMtags.Items.BALL_4)
                .input(Tags.Items.ORES_DIAMOND)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.EMERALD, 3).ball(POMtags.Items.BALL_3)
                .input(Tags.Items.ORES_EMERALD)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.RAW_IRON, 4).ball(POMtags.Items.BALL_3)
                .input(Tags.Items.ORES_IRON)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.RAW_COPPER, 12).ball(POMtags.Items.BALL_3)
                .input(Tags.Items.ORES_COPPER)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.RAW_GOLD, 4).ball(POMtags.Items.BALL_3)
                .input(Tags.Items.ORES_GOLD)
                .finish(fConsumer, this);
        BallMillRecipeBuilder.build(Items.QUARTZ, 4).ball(POMtags.Items.BALL_3)
        ...
        BallMillRecipeBuilder.build(POMitems.RAW_TITANIUM.get(), 4).ball(POMtags.Items.BALL_4)
                .input(POMtags.Items.ORES_TITANIUM)
                .finish(fConsumer, this);
...
//        autoPixelAssembling(Items.AMETHYST_SHARD, List.of(toCI(POMitems.PIXEL.get(), 9), toCI(Items.LAPIS_LAZULI, 9)), "element.pixelsofmc.helium", Element.HELIUM.hexToRGB(0), Element.HELIUM.hexToRGB(1), Element.HELIUM.hexToRGB(2),  fConsumer);
        ...
        ChemicalSeparatorRecipeBuilder.build(POMitems.DEPLETED_ENRICHED_PLUTONIUM_FUEL_CELL.get(), POMfluids.NITRIC_ACID.get(), 500)
                ...
                .output(POMitems.EMPTY_FUEL_CELL.get())
                .finish(fConsumer, this);
        ChemicalSeparatorRecipeBuilder.build(POMitems.PYROLYTIC_CARBON.get(), 2, POMfluids.OXYGEN_GAS.get(), 125)
        ...
        ChemicalSeparatorRecipeBuilder.build(Tags.Items.ORES_IRON, 1, POMfluids.SULFURIC_ACID.get(), 50)
                ...
                .finish(fConsumer, this);
        ChemicalSeparatorRecipeBuilder.build(Tags.Items.ORES_GOLD, 1, POMfluids.SULFURIC_ACID.get(), 50)
                .output(Items.RAW_GOLD, 6)
                .output(POMfluids.DIRTY_WATER.get(), 75)
                .finish(fConsumer, this);
        ChemicalSeparatorRecipeBuilder.build(POMtags.Items.ORES_TITANIUM, 1, POMfluids.SULFURIC_ACID.get(), 50)
                .output(POMitems.RAW_TITANIUM.get(), 6)
                .output(POMfluids.DIRTY_WATER.get(), 75)
                .finish(fConsumer, this);
        ChemicalSeparatorRecipeBuilder.build(Tags.Items.ORES_COPPER, 1, POMfluids.SULFURIC_ACID.get(), 50)
                .output(Items.RAW_COPPER, 40)
                .output(POMfluids.DIRTY_WATER.get(), 75)
                .finish(fConsumer, this);
        ChemicalSeparatorRecipeBuilder.build(Tags.Items.ORES_EMERALD, 1, POMfluids.SULFURIC_ACID.get(), 50)
                .output(Items.EMERALD, 4)
                .output(POMfluids.DIRTY_WATER.get(), 75)
                .finish(fConsumer, this);
        ChemicalSeparatorRecipeBuilder.build(Tags.Items.ORES_DIAMOND, 1, POMfluids.SULFURIC_ACID.get(), 50)
                .output(Items.DIAMOND, 4)
                .output(POMfluids.DIRTY_WATER.get(), 75)
                .finish(fConsumer, this);
        ChemicalSeparatorRecipeBuilder.build(Tags.Items.ORES_QUARTZ, 1, POMfluids.SULFURIC_ACID.get(), 50)
...
//                .save(fConsumer);
        ...
        SimpleFullCrossRecipe(Element.TITANIUM.item(), POMitems.COPPER_WIRE.get(), POMitems.ADVANCED_CIRCUIT_BOARD_1.get(), POMblocks.ENERGY_PORT.get(), fConsumer);
        SimpleFullCrossRecipe(Element.TITANIUM.item(), Items.HOPPER, POMitems.ADVANCED_CIRCUIT_BOARD_1.get(), POMblocks.ITEM_PORT.get(), fConsumer);
        SimpleFullCrossRecipe(Element.TITANIUM.item(), Items.BUCKET, POMitems.ADVANCED_CIRCUIT_BOARD_1.get(), POMblocks.FLUID_PORT.get(), fConsumer);
        ...
        SimpleCompactingRecipe(POMitems.PYROLYTIC_CARBON.get(), POMblocks.PYROLYTIC_CARBON_BLOCK.get(), fConsumer);
        ...
        SimpleSmeltingRecipe(POMitems.QUARTZ_DUST.get(), Items.QUARTZ, 0.5f, fConsumer, toItemP(Items.QUARTZ), "");
        ...
        SingleItemRecipeBuilder.stonecutting(toI(POMblocks.MACHINE_CASING.get()), RecipeCategory.BUILDING_BLOCKS, POMblocks.MACHINE_CASING_STAIRS.get())
                .unlockedBy("", inventoryTrigger(ItemPredicate.ANY))
                .save(fConsumer, toRL(getItemName(POMblocks.MACHINE_CASING_STAIRS.get()))+"_cutting");
        SingleItemRecipeBuilder.stonecutting(toI(POMblocks.MACHINE_CASING.get()), RecipeCategory.BUILDING_BLOCKS, POMblocks.MACHINE_CASING_SLAB.get(), 2)
                .unlockedBy("", inventoryTrigger(ItemPredicate.ANY))
                .save(fConsumer, toRL(getItemName(POMblocks.MACHINE_CASING_SLAB.get()))+"_cutting");
        ...
        SingleItemRecipeBuilder.stonecutting(toI(POMblocks.ARMORED_MACHINE_CASING.get()), RecipeCategory.BUILDING_BLOCKS, POMblocks.ARMORED_MACHINE_CASING_STAIRS.get())
                .unlockedBy("", inventoryTrigger(ItemPredicate.ANY))
                .save(fConsumer, toRL(getItemName(POMblocks.ARMORED_MACHINE_CASING_STAIRS.get()))+"_cutting");
        SingleItemRecipeBuilder.stonecutting(toI(POMblocks.ARMORED_MACHINE_CASING.get()), RecipeCategory.BUILDING_BLOCKS, POMblocks.ARMORED_MACHINE_CASING_SLAB.get(), 2)
                .unlockedBy("", inventoryTrigger(ItemPredicate.ANY))
    ...
    private void calculatePossibleFusions() {
