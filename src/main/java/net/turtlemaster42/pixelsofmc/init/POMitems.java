...
public class POMitems {
	...
	//tools
	public static final RegistryObject<Item> CLEANING_CLOTH = ITEMS.register("cleaning_cloth", () -> new CleaningClothItem(new Item.Properties().durability(192)));
	public static final RegistryObject<Item> SCREWDRIVER = ITEMS.register("screwdriver", () -> new ScrewDriverItem(new Item.Properties().durability(300)));
	public static final RegistryObject<Item> WIRECUTTER = ITEMS.register("wirecutter", () -> new ToolItem(new Item.Properties().durability(300)));
	public static final RegistryObject<Item> HAMMER = ITEMS.register("hammer", () -> new ToolItem(new Item.Properties().durability(540).fireResistant()));
	...
	public static final RegistryObject<Item> LITHIUM_FLUORIDE_CLUMP = ITEMS.register("lithium_fluoride_clump", () -> new Item(new Item.Properties()));
	...
	public static final RegistryObject<Item> DEPLETED_URANIUM_FUEL_CELL = ITEMS.register("depleted_uranium_fuel_cell", () -> new FuelCellItem(new Item.Properties().stacksTo(16), 25, "textures/item/depleted_uranium_fuel_model.png"));
	...
	public static final RegistryObject<Item> DEPLETED_ENRICHED_URANIUM_FUEL_CELL = ITEMS.register("depleted_enriched_uranium_fuel_cell", () -> new FuelCellItem(new Item.Properties().stacksTo(16), 100, "textures/item/depleted_enriched_uranium_fuel_model.png"));
	...
	public static final RegistryObject<Item> DEPLETED_PLUTONIUM_FUEL_CELL = ITEMS.register("depleted_plutonium_fuel_cell", () -> new FuelCellItem(new Item.Properties().stacksTo(16), 400, "textures/item/depleted_plutonium_fuel_model.png"));
	...
	public static final RegistryObject<Item> DEPLETED_ENRICHED_PLUTONIUM_FUEL_CELL = ITEMS.register("depleted_enriched_plutonium_fuel_cell", () -> new FuelCellItem(new Item.Properties().stacksTo(16), 1600, "textures/item/depleted_enriched_plutonium_fuel_model.png"));
	...
	public static final RegistryObject<Item> PLUTONIUM_TETRAFLUORIDE_DUST = DUSTS.register("plutonium_tetrafluoride_dust", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> PLUTONIUM_HEXAFLUORIDE_DUST = DUSTS.register("plutonium_hexafluoride_dust", () -> new Item(new Item.Properties()));
	public static final RegistryObject<Item> ENRICHED_PLUTONIUM_HEXAFLUORIDE_DUST = DUSTS.register("enriched_plutonium_hexafluoride_dust", () -> new Item(new Item.Properties()));
	...
	public static final RegistryObject<Item> HYDROFLUORIC_ACID_BUCKET = BUCKETS.register("hydrofluoric_acid_bucket", () -> new BucketItem(POMfluids.HYDROFLUORIC_ACID, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
	...
	public static final RegistryObject<Item> ENRICHED_URANIUM_SOLUTION_BUCKET = BUCKETS.register("enriched_uranium_solution_bucket", () -> new BucketItem(POMfluids.ENRICHED_URANIUM_SOLUTION, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
	...
	public static final RegistryObject<Item> ENRICHED_PLUTONIUM_SOLUTION_BUCKET = BUCKETS.register("enriched_plutonium_solution_bucket", () -> new BucketItem(POMfluids.ENRICHED_PLUTONIUM_SOLUTION, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
	...
	public static final RegistryObject<Item> FLUORINE_GAS_BUCKET = BUCKETS.register("fluorine_gas_bucket", () -> new GasBucketItem(POMfluids.FLUORINE_GAS, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
	...
	public static final RegistryObject<Item> URANIUM_HEXAFLUORIDE_GAS_BUCKET = BUCKETS.register("uranium_hexafluoride_gas_bucket", () -> new GasBucketItem(POMfluids.URANIUM_HEXAFLUORIDE_GAS, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));
