...
public class POMfluids {
    ...
    public static final ForgeFlowingFluid.Properties MERCURY_PROPERTIES = new ForgeFlowingFluid.Properties(
            ...
            .block(() -> POMfluids.HONEY_BLOCK.get()).bucket(() -> POMitems.MERCURY_BUCKET.get());

    public static final RegistryObject<LiquidBlock> HONEY_BLOCK = POMblocks.BLOCKS.register("mercury",
