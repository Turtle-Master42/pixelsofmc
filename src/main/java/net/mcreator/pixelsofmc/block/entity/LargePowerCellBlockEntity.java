...
public class LargePowerCellBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public LargePowerCellBlockEntity(BlockPos position, BlockState state) {
		super(PixelsOfMcModBlockEntities.LARGE_POWER_CELL.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("large_power_cell");
	}
	...
	public Component getDisplayName() {
		return new TextComponent("Large Power Cell");
	}
